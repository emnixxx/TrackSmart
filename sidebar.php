...
<div class="sidebar">
    ...
    <a href="expenses.php" class="menu-item"> <svg class="sidebar-icon-svg" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="profile.php" class="menu-item"> <svg class="sidebar-icon-svg" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
