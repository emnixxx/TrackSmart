<div class="sidebar">
    ...
    <a href="budgets.php" class="menu-item"> <svg class="sidebar-icon-svg" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="#" onclick="confirmLogout()" class="menu-item logout"> <svg class="sidebar-icon-svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
